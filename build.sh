...
# Compile the kernel.c, vga.c and keyboard.c to object files with gcc
...
ld -m elf_i386 -T src/linker/linker.ld -o iso/boot/kernel build/kernel.asm.o build/io.asm.o build/kernel.o build/vga.o build/keyboard.o build/string.o
